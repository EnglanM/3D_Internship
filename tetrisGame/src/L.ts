...
export class L {
    ...
    create= () => {
       this.plane1= MeshBuilder.CreatePlane(`plane${this.number}`,{size:1});
        ...
        this.plane3.position=new Vector3(-0.5,6.5,0);
        ...
        this.plane4.position=new Vector3(-0.5,5.5,0);
        ...
        if (x !== undefined && y !== undefined &&this.plane1 &&this.plane2 &&this.plane3 &&this.plane4) {
            switch (this.rotateRight){
                case 0:{
                    ...
                    this.plane4.position= new Vector3(x-2,y,0);
                    this.rotateRight++;
                    break;
                }
                case 1:{
                    ...
                    this.plane4.position= new Vector3(x,y+2,0);
                    this.rotateRight++;
                    break;
                }
                case 2:{
